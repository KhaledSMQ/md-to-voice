...
export const READING_TYPOGRAPHIES: readonly ReadingTypographyMeta[] = [
  {
    ...
    sample: 'Aa',
    stack: "'Literata Variable', 'Literata', ui-serif, 'Iowan Old Style', Palatino, Georgia, serif",
    tracking: '0.006em',
    leading: '1.75',
  },
  {
    ...
    sample: 'Aa',
    stack: "'Source Serif 4 Variable', 'Source Serif 4', 'Source Serif Pro', 'Iowan Old Style', Georgia, serif",
    tracking: '0.004em',
    leading: '1.78',
  },
  {
    ...
    sample: 'Aa',
    stack: "'Source Sans 3 Variable', 'Source Sans 3', ui-sans-serif, 'Segoe UI', system-ui, sans-serif",
    tracking: '0.008em',
    leading: '1.7',
  },
  {
